                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i class="fas fa-user-circle me-2"></i> <span class="blink">Rank:</span></td>
                                ...
                                <tr>
                                    <td ><a href="https://wa.me/?text={{ asset('') }}register?ref={{ Auth::user()->username }}"  target="_blank"  style="color:#fff;    text-decoration: none;"><i class="fa fa-whatsapp" ></i> Referral Link: </a> </td>
                                    <td class="text-end">
