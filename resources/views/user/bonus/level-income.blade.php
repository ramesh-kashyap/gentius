                ...
                <div class="project-info-form style">
                        ...
                        <tbody>
                            <tr>
                                <div class="filter-search-container">
                                    ...
                                    <form method="GET" action="{{ route('user.level-income') }}">
                                        @csrf
                    ...
                    <div class="table-responsive">
                        <table cellspacing="1" cellpadding="2" border="0" width="100%"
                            ...
                            <tbody>
                                @forelse($level_income as $withdraw)

                                <tr>
                                    <td class="td">{{ $loop->iteration }}</td> <!-- S.NO -->

                                    <td class="td"> {{ $withdraw->amt }}
                                    </td>
                                    <td class="td"> ${{ $withdraw->comm }}
                                    </td>
                                    <td class="td"> {{ $withdraw->remarks }}
                                    </td>
